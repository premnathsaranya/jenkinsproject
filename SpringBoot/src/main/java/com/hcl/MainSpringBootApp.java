...
public class MainSpringBootApp {
	...
	/*
	 * @RequestMapping("/find/{code}/{name}") public List<Country>
	 * findcodeandname(@PathVariable String code,@PathVariable String name){
	 * List<Country> country = dao.findByCodeAndName(code,name); return country;
	 * 
	 * }
	 */
	@RequestMapping("/find")
